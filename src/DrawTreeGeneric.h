...
/*Draw the time scale at position x/y using the active backend.*/
void drawScaleGeneric(double x, double y, TypeInfoDrawTreeGeneric *info);
/*Render a tree to a file using the active backend and optional overlays.*/
...
/*Render a tree with debug information using the active backend.*/
